...
public class LinkedListTest {
    ...
    @Before
    public void setUp() {
        linkedList = new LinkedList().addNode(1).addNode(2).addNode(3).addNode(4).addNode(5);
    }

    @Test
    public void getSize0() {
        Assert.assertEquals(0, new LinkedList().getSize());
    }
    ...
    public void setValueByIndex0() {
        Assert.assertTrue(verifyResult(new Object[]{11, 2, 3, 4, 5}, linkedList.setValueByIndex(0, 11)));
    }

    @Test
    public void setValueByIndex1() {
        Assert.assertTrue(verifyResult(new Object[]{1, 12, 3, 4, 5}, linkedList.setValueByIndex(1, 12)));
    }

    @Test
    public void setValueByIndex10() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 3, 4, 5}, linkedList.setValueByIndex(10, 10)));
    }

    @Test
    public void addNode0() {
        Assert.assertTrue(verifyResult(new Object[]{0}, new LinkedList().addNode(0)));
    }

    @Test
    public void addNode6() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 3, 4, 5, 6}, linkedList.addNode(6)));
    }

    @Test
    public void insertAfterNode0() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 3, 4, 5}, new LinkedList().insertAfterNodeValue(0, 10)));
    }

    @Test
    public void insertAfterNode1() {
        Assert.assertTrue(verifyResult(new Object[]{1, 11, 2, 3, 4, 5}, linkedList.insertAfterNodeValue(1, 11)));
    }

    @Test
    public void insertAfterNode2() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 12, 3, 4, 5}, linkedList.insertAfterNodeValue(2, 12)));
    }

    @Test
    public void insertAfterNode5() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 3, 4, 5, 15}, linkedList.insertAfterNodeValue(5, 15)));
    }
    ...
    public void testVerifyResult() {
        Assert.assertTrue(verifyResult(new Object[]{1, 2, 3, 4, 5}, linkedList));
    }

    private boolean verifyResult(Object[] predictResults, LinkedList linkedList) {
